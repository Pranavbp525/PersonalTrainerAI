...
Revision ID: 9371005d3cf5
Revises: 
Create Date: 2025-04-19 13:15:08.830082
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('thumbs_up', sa.Boolean(), nullable=True))
