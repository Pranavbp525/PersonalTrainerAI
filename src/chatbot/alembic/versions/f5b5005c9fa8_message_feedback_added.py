...
Revision ID: f5b5005c9fa8
Revises: 92773aeb1d83
Create Date: 2025-04-20 00:39:18.374451
...
revision: str = 'f5b5005c9fa8'
down_revision: Union[str, None] = '92773aeb1d83'
...
def upgrade() -> None:
    ...
    op.add_column('messages', sa.Column('thumbs_up', sa.Boolean(), nullable=True))
    op.drop_column('users', 'thumbs_up')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('users', sa.Column('thumbs_up', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.drop_column('messages', 'thumbs_up')
