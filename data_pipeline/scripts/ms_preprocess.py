...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("preprocessing.log"),  # ✅ Saves logs to 'preprocessing.log'
...
if __name__ == "__main__":
    ...
    filename = "processed_workout_data.json"
    try:
        with open(filename, "w", encoding="utf-8") as f:
            json.dump(processed_workouts, f, indent=4, ensure_ascii=False)
        logger.info(f"Successfully saved processed data to {filename}")  # ✅ Log save success
    except Exception as e:
